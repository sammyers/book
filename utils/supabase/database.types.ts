...
import type { CompositeTypes, Database as DatabaseGenerated } from "./database-generated.types";

export const fieldingPositions = GeneratedConstants.public.Enums.fielding_position;

export type { Json, Tables, Enums, CompositeTypes } from "./database-generated.types";
